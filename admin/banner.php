...
?>
	...
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="sub-title" placeholder="Enter sub title" name="sub-title" data-rule="sub-title" data-msg="Please include valid sub tiltle">
    <div class="validation"></div>
	</div> 
	<div class="form-group">
