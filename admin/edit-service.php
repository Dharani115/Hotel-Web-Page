...
if(isset($_POST['submit']))
{
	...
	$query="update servise set title='$title',icon='$icon',description='$description',modified_on='$modified_on' where  ID='$edit_id'";
...
$edit_id=$_GET['editid'];
$ret=mysqli_query($con,"select * from `servise` where ID=$edit_id");
