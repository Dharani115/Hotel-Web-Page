...
if(isset($_POST['submit']))
{
  ...
  // Check if file already exists
	...
	$query="INSERT into `menu` ( menu_name,menu_image, created_on,  modified_on)
	VALUES ('$title','$menu_image','$created_on', '$modified_on')";
	printf($query);
...
?>
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="title" placeholder="Enter title" name="title" data-rule="title" data-msg="Please include valid title">
    <div class="validation"></div>
	</div>
	<div class="form-group">
      <label for="image">Image</label>
      <input type="file" class="form-control" id="menu_image" placeholder="Enter food Image" onchange="return fileValidation()" name="menu_image" data-rule="required" data-msg="Please include Food image">
    <div class="validation"></div>
	</div>	
...
<script type="text/javascript"> 
		 ...
		 function fileValidation() { 
            var fileInput =  
                document.getElementById('menu_image'); 
