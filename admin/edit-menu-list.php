...
?>
		<div class="form-group">
			  ...
			  <input type="text" class="form-control" id="name" placeholder="Enter Title" name="name" data-rule="required" data-msg="This feild is required" value="<?php  echo $row['item_name'];?>">
